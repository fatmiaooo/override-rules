...
(() => {
  ...
  var init_rules = __esm({
    "src/rules.ts"() {
      ...
      baseRules = [
        ...
        `RULE-SET,CustomAI,${PROXY_GROUPS.AI_SERVICE}`,
  ...
  var CUSTOM_RULESET_BASE_URL, ruleProviders;
  var init_rule_providers = __esm({
    "src/rule_providers.ts"() {
      "use strict";
      init_constants();
      CUSTOM_RULESET_BASE_URL = "https://raw.githubusercontent.com/fatmiaooo/override-rules/refs/heads/main/ruleset";
      ruleProviders = {
        CustomReject: {
          type: "http",
          behavior: "classical",
